...
public class TARelationId implements Serializable {
    ...
    public TARelationId(String userId, String classCode, String quarter, String year) {
        this.userId = userId;
    ...
    public boolean equals(Object o) {
        ...
        TARelationId that = (TARelationId) o;
